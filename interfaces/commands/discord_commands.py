...
def register_commands(tree: app_commands.CommandTree):
    """
    Register all Discord slash commands to the given command tree.
    """
    ...
    async def capture_command(
        ...
        """
        Handle the /capture slash command. Parses message_ids and participants, and replies with the parsed info.
        """
        # Parse message_ids
